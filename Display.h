...
#define OLED_CLK   4 //7 A5_IO4   // 4teidi 39
#define OLED_MOSI  27//8 IO27_A10
//pin 36 39 sadece input
//pin 12 de invalid header uyarisi
#endif
*/
#ifdef ESP32_ADAFRUIT
//#define OLED_GND A2// 13
//#define OLED_POWER A3//
#define OLED_MOSI    21//1 IO_21
#define OLED_CLK 17//2 IO_17
#define OLED_DC    16//3 IO_16
#define OLED_RESET   27 //7 A5_IO4   // 4teidi 39
#define OLED_CS  4//8 IO27_A10
//pin 36 39 sadece input
//pin 12 de invalid header uyarisi
#endif
...
void DisplayInit(void) {
 ...
 delay(1300);
  ...
  else Serial.println(F("SSD1306 works"));
    display.dim(0); // lower brightness
...
void UpdateDisplayMenu(void) {
  ...
  switch (MainMenu) {
    ...
    case MENU4_SUB1 :
      ...
      break;
    case MENU4_SUB2 :
      str = "Dev Id: " ;  // fw version compile time
      break;
    case MENU4_SUB3 :
